public class WeaponRunner {
    public static void main(String[] args) {
        ...
        weapon2.type = "Ranged";
        weapon2.weight = 2.0;
        weapon2.material = "Wood";
        weapon2.origin = "India";
        ...
        weapon6.type = "Melee";
        weapon6.weight = 3.0;
        weapon6.material = "Wood and Iron";
        weapon6.origin = "Africa";
        ...
        weapon7.name = "Crossbow";
        weapon7.type = "Ranged";
        weapon7.weight = 5.5;
        weapon7.material = "Wood and Steel";
        weapon7.origin = "France";
        ...
        weapon10.name = "Boomerang";
        weapon10.type = "Ranged";
        weapon10.weight = 1.2;
        weapon10.material = "Wood";
        weapon10.origin = "Australia";
        ...
        weapon11.type = "Melee";
        weapon11.weight = 1.1;
        weapon11.material = "Leather";
        weapon11.origin = "Brazil";
        ...
        weapon12.type = "Melee";
        weapon12.weight = 2.5;
        weapon12.material = "Wood";
        weapon12.origin = "China";
        ...
        weapon13.name = "Hammer";
        weapon13.type = "Melee";
        weapon13.weight = 6.0;
        weapon13.material = "Iron";
        weapon13.origin = "Viking";
        ...
        weapon14.type = "Melee";
        weapon14.weight = 4.0;
        weapon14.material = "Steel";
        weapon14.origin = "England";
        ...
        weapon15.name = "Musket";
        weapon15.type = "Ranged";
        weapon15.weight = 7.0;
        weapon15.material = "Wood and Steel";
        weapon15.origin = "France";
