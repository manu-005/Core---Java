public class FishRunner {
    public static void main(String[] args) {
        Fish fish1 = new Fish();
        fish1.species = "Clownfish";
        fish1.habitat = "Coral Reef";
        fish1.size = 10.0;
        fish1.color = "Orange";

        System.out.println("Species: " + fish1.species);
        System.out.println("Habitat: " + fish1.habitat);
        System.out.println("Size: " + fish1.size + " cm");
        ...
        System.out.println("Size: " + fish5.size + " cm");
        ...
        System.out.println("Size: " + fish8.size + " cm");
        ...
        System.out.println("Size: " + fish9.size + " cm");
        System.out.println("Color: " + fish9.color);        

        Fish fish10 = new Fish();
        fish10.species = "Pufferfish";
